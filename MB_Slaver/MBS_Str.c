...
*****************************************************
* Method:       CRC16_Modbus
* Description:	计算CRC。 用于Modbus协议。
* Author:       @Draven 
* Date:  		2017/05/08
* Returns:      uint16_t
* Parameter:   	uint8_t * _pBuf		参与校验的数据
* Parameter:   	uint16_t _usLen		数据长度
* History:		对于Modbus ，此结果高字节先传送，低字节后传送。
*****************************************************
*/
...
/*
*****************************************************
* Method:       BEBufToUint16
* Description:	将2字节数组(大端Big Endian次序，高字节在前)转换为16位整数
* Author:       @Draven 
* Date:  		2017/05/08
* Returns:      uint16_t
...
/*
*****************************************************
* Method:       LEBufToUint16
* Description:	将2字节数组(小端Little Endian，低字节在前)转换为16位整数
* Author:       @Draven 
* Date:  		2017/05/08
* Returns:      uint16_t
* Parameter:   	uint8_t * _pBuf
